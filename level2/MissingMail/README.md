You are the manager of a mail room which is frequently subject to theft. A period of $N$ days is about to occur, such that on the iith day, the following sequence of events will occur in order:
